...
function PostBeginPlay()
{
    ...
    if (!bInitialized)
    {
        ...
        log("[~] Genesis2001 - www.cncfps.com");
...
event Timer()
{
    ...
    switch (iAdType)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            iCurPos = rand(nLines); // begin at a random position
...
{  
    ...
    if (left(Msg,1) == "#" )
    {
        ...
        if (DEBUG)
        {
            log("[D] ServerAdsKF admin line: " $ Msg);
        }
